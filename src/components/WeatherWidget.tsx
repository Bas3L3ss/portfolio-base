...
const WeatherWidget = () => {
  return (
    <motion.div
      ...
      className="relative"
    >
      <div className="bg-gradient-to-br  backdrop-blur-lg rounded-3xl text-white p-5 shadow-lg w-full mx-auto overflow-hidden">
      ...
      <motion.div
        ...
        className="      shadow-sm mt-2 mx-auto w-fit"
      >
